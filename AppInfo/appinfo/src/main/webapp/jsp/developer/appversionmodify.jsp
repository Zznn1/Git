...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>修改APP最新版本信息 <i class="fa fa-user"></i><small>${devLogin.devname}</small></h2>
            <div class="clearfix"></div>
      </div>
      <div class="x_title">
            <h2>历史版本列表</h2>
	  ...
	  <p class="text-muted font-13 m-b-30"></p>
        ...
        <div class="x_content" style="display: block;">
         <br>
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath }/appInfo/updateAppVersion" onsubmit="return checkText()" method="post" enctype="multipart/form-data">
           <input type="hidden" name="id" id="id" value="${oneInfo.id}">
           <input type="hidden" name="appId" id="appId" value="${oneInfo.appid}">
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">版本号 <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input class="form-control col-md-7 col-xs-12" value="${oneInfo.versionno}"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" id="versionSize" name="versionsize" value="${oneInfo.versionsize}"  required="required"
          ...
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="hidden" id="downloadLink" name="downloadLink" value="${oneInfo.downloadlink}"/>
            <input type="hidden" id="apkLocPath" name="apkLocPath" value="${oneInfo.apklocpath}"/>
            <input type="hidden" id="apkFileName" name="apkFileName" value="${oneInfo.apkfilename}"/>
			<div id="uploadfile">
				<input id="attach" type="file" class="form-control col-md-7 col-xs-12" name="multipartFile">
