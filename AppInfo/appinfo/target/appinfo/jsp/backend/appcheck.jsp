...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>查看并审核APP信息 <i class="fa fa-user"></i>${login.username}></h2>
             <div class="clearfix"></div>
      </div>
      <div class="x_title">
            <h2>APP基础信息</h2>
      ...
      <div class="x_content1">
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath }/appInfo/checksave" method="post">
          <input type="hidden" name="id" value="${oneInfo.id}">
        ...
        <form class="form-horizontal form-label-left">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" value="<%--${oneInfo.versionSize }--%>" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
